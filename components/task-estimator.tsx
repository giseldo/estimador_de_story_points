  ...
  const handleAiEstimate = async (selectedModel: string) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || "Erro ao obter estimativa da IA")
      }
      ...
      setAiError(error instanceof Error ? error.message : "Erro desconhecido")
    } finally {
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-slate-600">
                ...
                preciso o modelo se tornará. O modelo é treinado automaticamente quando você salva uma nova tarefa, mas
                você também pode treiná-lo manualmente.
              </p>
